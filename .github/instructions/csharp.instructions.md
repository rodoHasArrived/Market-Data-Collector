...
8. All domain exceptions must derive from `MarketDataCollectorException` (in `src/MarketDataCollector.Core/Exceptions/`); never throw bare `Exception` or `ApplicationException`.
