...
/// <summary>
/// Generates supplementary scripts and documentation for portable data packages.
/// Extracted from PortableDataPackager to separate script generation from package I/O.
/// Supports Python, R, PostgreSQL, ClickHouse, DuckDB, and Spark import scripts.
/// </summary>
public sealed class PackageScriptGenerator
{
    /// <summary>
    /// Generate a README for a data package.
    /// </summary>
    public string GenerateReadme(PackageManifest manifest, PackageOptions options)
    {
    ...
    /// <summary>
    /// Generate a data dictionary from package schema information.
    /// </summary>
    public string GenerateDataDictionary(PackageManifest manifest)
    {
        var sb = new StringBuilder();
    ...
    /// <summary>
    /// Generate a Python data loader script.
    /// </summary>
    public string GeneratePythonLoader(PackageManifest manifest)
    {
        var sb = new StringBuilder();
    ...
    /// <summary>
    /// Generate an R data loader script.
    /// </summary>
    public string GenerateRLoader(PackageManifest manifest)
    {
        var sb = new StringBuilder();
        sb.AppendLine("# Data Loader for " + manifest.Name);
        sb.AppendLine("# Package ID: " + manifest.PackageId);
    ...
    /// <summary>
    /// Generate an import script for the specified target platform.
    /// </summary>
    public string GenerateImportScript(PackageManifest manifest, ImportScriptTarget target)
    {
    ...
    /// </summary>
    public string GeneratePostgreSqlImport(PackageManifest manifest)
    {
        var sb = new StringBuilder();
    ...
    /// <summary>
    /// Generate a ClickHouse import script.
    /// </summary>
    public string GenerateClickHouseImport(PackageManifest manifest)
    {
        var sb = new StringBuilder();
    ...
    /// <summary>
    /// Generate a DuckDB import script.
    /// </summary>
    public string GenerateDuckDbImport(PackageManifest manifest)
    {
        var sb = new StringBuilder();
    ...
    /// <summary>
    /// Generate a Python database import script.
    /// </summary>
    public string GeneratePythonImport(PackageManifest manifest)
    {
        var sb = new StringBuilder();
        sb.AppendLine("#!/usr/bin/env python3");
        sb.AppendLine("\"\"\"");
    ...
    /// <summary>
    /// Generate an R database import script.
    /// </summary>
    public string GenerateRImport(PackageManifest manifest)
    {
        var sb = new StringBuilder();
        sb.AppendLine("# Database Import Script for " + manifest.Name);
        sb.AppendLine("# Package ID: " + manifest.PackageId);
    ...
    /// <summary>
    /// Generate an Apache Spark import script.
    /// </summary>
    public string GenerateSparkImport(PackageManifest manifest)
    {
        var sb = new StringBuilder();
        sb.AppendLine("#!/usr/bin/env python3");
        sb.AppendLine("\"\"\"");
