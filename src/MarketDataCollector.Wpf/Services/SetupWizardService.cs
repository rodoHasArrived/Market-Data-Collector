...
public sealed class SetupWizardService
{
    ...
    /// </summary>
    public async Task<WizardProviderTestResult> TestProviderConnectivityAsync(
        string provider,
        Dictionary<string, string> credentials,
        CancellationToken ct = default)
    {
        var result = new WizardProviderTestResult { Provider = provider };
    ...
    private async Task<WizardProviderTestResult> TestAlpacaAsync(
        Dictionary<string, string> credentials,
        CancellationToken ct)
    {
        var result = new WizardProviderTestResult { Provider = "Alpaca" };
    ...
    private async Task<WizardProviderTestResult> TestPolygonAsync(
        Dictionary<string, string> credentials,
        CancellationToken ct)
    {
        var result = new WizardProviderTestResult { Provider = "Polygon" };
    ...
    private async Task<WizardProviderTestResult> TestInteractiveBrokersAsync(
        Dictionary<string, string> credentials,
        CancellationToken ct)
    {
        var result = new WizardProviderTestResult { Provider = "Interactive Brokers" };
    ...
    private async Task<WizardProviderTestResult> TestStockSharpAsync(
        Dictionary<string, string> credentials,
        CancellationToken ct)
    {
        var result = new WizardProviderTestResult { Provider = "StockSharp" };
    ...
    private static WizardProviderTestResult ValidateUsernamePassword(string provider, string? username, string? password)
    {
        if (string.IsNullOrWhiteSpace(username) || string.IsNullOrWhiteSpace(password))
        {
            return new WizardProviderTestResult
            {
                Provider = provider,
                Success = false,
    ...
    private static async Task<WizardProviderTestResult> TestTcpEndpointAsync(
        string provider,
        string host,
        string portStr,
        CancellationToken ct)
    ...
    private async Task<WizardProviderTestResult> TestTiingoAsync(
        Dictionary<string, string> credentials,
        CancellationToken ct)
    {
        var result = new WizardProviderTestResult { Provider = "Tiingo" };
    ...
    private async Task<WizardProviderTestResult> TestFinnhubAsync(
        Dictionary<string, string> credentials,
        CancellationToken ct)
    {
        var result = new WizardProviderTestResult { Provider = "Finnhub" };
    ...
    private async Task<WizardProviderTestResult> TestAlphaVantageAsync(
        Dictionary<string, string> credentials,
        CancellationToken ct)
    {
        var result = new WizardProviderTestResult { Provider = "Alpha Vantage" };
...
/// </summary>
public class WizardProviderTestResult
{
