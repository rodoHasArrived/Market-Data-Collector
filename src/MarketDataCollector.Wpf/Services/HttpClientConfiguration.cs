...
/// <summary>
/// Named HttpClient identifiers for IHttpClientFactory in WPF.
...
/// This is a standalone implementation for WPF since it cannot reference the main project.
/// </remarks>
...
/// <summary>
/// Extension methods for configuring HttpClient instances via IHttpClientFactory in WPF.
/// </summary>
/// <remarks>
/// Implements TD-10: Replace instance HttpClient with IHttpClientFactory.
/// Benefits:
...
public static class HttpClientConfiguration
{
    ...
    /// <summary>
    /// Registers all named HttpClient configurations with the DI container for WPF.
    /// </summary>
    public static IServiceCollection AddWpfHttpClients(this IServiceCollection services)
    {
        // Default client
...
/// <summary>
/// Static factory for creating HttpClient instances from IHttpClientFactory in WPF.
...
public static class HttpClientFactoryProvider
{
    ...
    public static void Initialize()
    {
        ...
        lock (_lock)
        {
            ...
            services.AddWpfHttpClients();
            _serviceProvider = services.BuildServiceProvider();
            _factory = _serviceProvider.GetService<IHttpClientFactory>();
            _isInitialized = true;

            System.Diagnostics.Debug.WriteLine("[HttpClientFactoryProvider] Initialized with named clients for WPF (TD-10)");
        }
    }
    ...
    {
        return CreateClient(HttpClientNames.Default);
    }
