...
/// <summary>
/// Provides command palette functionality for quick navigation across all desktop app pages.
...
public sealed class CommandPaletteService
{
    ...
    private void RegisterDefaultCommands()
    {
        ...
        AddNavCommand("Activity Log", "Support", "activity log audit history", typeof(Views.ActivityLogPage));
