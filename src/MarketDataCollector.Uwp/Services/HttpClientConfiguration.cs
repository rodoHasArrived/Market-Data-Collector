...
/// This is a standalone implementation for UWP since it cannot reference the main project.
/// </remarks>
...
public static class HttpClientConfiguration
{
    ...
    /// </summary>
    public static IServiceCollection AddUwpHttpClients(this IServiceCollection services)
    {
        // Default client
...
public static class HttpClientFactoryProvider
{
    ...
    public static void Initialize()
    {
        ...
        lock (_lock)
        {
            ...
            services.AddUwpHttpClients();
            _serviceProvider = services.BuildServiceProvider();
            _factory = _serviceProvider.GetService<IHttpClientFactory>();
            _isInitialized = true;

            System.Diagnostics.Debug.WriteLine("[HttpClientFactoryProvider] Initialized with named clients for UWP (TD-10)");
        }
    }
