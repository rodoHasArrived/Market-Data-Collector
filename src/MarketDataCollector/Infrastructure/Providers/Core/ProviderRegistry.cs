...
using Serilog;
using Contracts = MarketDataCollector.Contracts;
...
public sealed class ProviderRegistry : IDisposable
{
    ...
    /// </summary>
    /// <returns>A list of <see cref="MarketDataCollector.Contracts.Api.ProviderCatalogEntry"/> objects for UI consumption.</returns>
    public IReadOnlyList<MarketDataCollector.Contracts.Api.ProviderCatalogEntry> GetProviderCatalog()
    {
        return _allProviders.Values
    ...
    /// <returns>A list of <see cref="MarketDataCollector.Contracts.Api.ProviderCatalogEntry"/> objects for UI consumption.</returns>
    public IReadOnlyList<MarketDataCollector.Contracts.Api.ProviderCatalogEntry> GetProviderCatalogByType(ProviderType type)
    {
        return _allProviders.Values
    ...
    public MarketDataCollector.Contracts.Api.ProviderCatalogEntry? GetProviderCatalogEntry(string providerId)
    {
