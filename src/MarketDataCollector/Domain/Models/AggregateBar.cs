using ContractsMarketEventPayload = MarketDataCollector.Contracts.Domain.Events.MarketEventPayload;
...
/// </remarks>
public sealed record AggregateBar : ContractsMarketEventPayload
{
    /// <summary>
