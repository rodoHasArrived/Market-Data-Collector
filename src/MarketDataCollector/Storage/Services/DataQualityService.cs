...
public sealed class DataQualityService : IDataQualityService
{
    ...
    public async Task<DataQualityReport> GenerateReportAsync(DataQualityReportOptions options, CancellationToken ct = default)
    {
...
public interface IDataQualityService
{
    ...
    Task<DataQualityReport> GenerateReportAsync(DataQualityReportOptions options, CancellationToken ct = default);
...
public sealed record DataQualityReportOptions(
    string[] Paths,
