...
/// <summary>
/// Concrete IB market data client. Buildable out-of-the-box:
...
/// </summary>
public sealed class IBMarketDataClient : IIBMarketDataClient
{
    private readonly IIBMarketDataClient _inner;
...
#if IBAPI
internal sealed class IBMarketDataClientIBApi : IIBMarketDataClient
{
