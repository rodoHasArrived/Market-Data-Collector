...
// 1. Uses old namespace 'IbDataCollector.Domain' (lowercase 'b') vs new 'MarketDataCollector.Domain'
...
//
// The active implementation is in: MarketDataCollector.Domain.Collectors.MarketDepthCollector
// =============================================================================
