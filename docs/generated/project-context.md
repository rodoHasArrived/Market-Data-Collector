...
**Generated:** 2026-01-31 09:52:50 UTC
...
| `PipelinePublisher` | `MarketDataCollector/Application/Composition/ServiceCompositionRoot.cs` | Provider services registered before dependent services |
| `PipelinePublisher` | `MarketDataCollector/Application/Composition/ServiceCompositionRoot.cs` | Uses ProviderRegistry for unified symbol search provider discovery |
| `PipelinePublisher` | `MarketDataCollector/Application/Composition/ServiceCompositionRoot.cs` | Uses ProviderRegistry for unified backfill provider discovery |
...
| `PipelinePublisher` | `MarketDataCollector/Application/Composition/ServiceCompositionRoot.cs` | HttpClientFactory lifecycle management |
